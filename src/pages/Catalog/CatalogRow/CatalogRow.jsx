...
const CatalogRow = () => {
    ...
    useEffect(() => {
        if (data.length > 0) {
            setPage(1); // Устанавливаем начальную страницу
        }
    }, [data]);

    const goToPage = (pageNumber) => {
        if (pageNumber >= 1 && pageNumber <= catalogPagesCount.length) {
            setPage(pageNumber);
        }
    };
        ...
        <div className="catalog__right">
            ...
            </div>
            {
                ...
                <div className="catalog__pagination">
                    <button className="catalog__pagination-btn1" onClick={() => goToPage(page - 1)}>
